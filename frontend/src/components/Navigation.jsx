...
export default function Navigation() {
  ...
  return (
    ...
    >
      {/* Trieda nav-container z index.css sa postará o správne rozostupy */}
      <div className="nav-container max-w-[1400px] mx-auto h-20 md:h-24">
        ...
        <div className="flex items-center gap-2 sm:gap-4 shrink-0">
          ...
          {/* Mobilné sociálne siete */}
          <div className="mobile-socials flex sm:hidden items-center gap-2 text-white">
          ...
          <a 
            ...
            className="btn-availability inline-flex items-center justify-center px-4 py-2 text-slate-900 bg-[#dfb144] hover:bg-[#cc9f37] rounded-full font-semibold text-xs transition-all duration-300 shadow-md hover:scale-105 whitespace-nowrap"
          >
            Overiť dostupnosť
          </a>
