    ...
    >
      <div className="nav-container max-w-[1400px] mx-auto flex items-center justify-between px-6 md:px-10 h-20 md:h-24">
        ...
        <div className="flex items-center gap-3 sm:gap-5">
          ...
          {/* Mobilné sociálne siete (viditeľné len v mobile vďaka sm:hidden) */}
          <div className="mobile-socials flex sm:hidden items-center gap-3 text-white">
          ...
          {/* Jazyky (skryté v mobile vďaka triede lang-switcher) */}
